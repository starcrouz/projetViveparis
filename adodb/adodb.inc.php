...
/** 
 * @version V1.65 28 Dec 2001 (c) 2000, 2001 John Lim (jlim@natsoft.com.my). All rights reserved.
...
*/
 ...
 if (!defined('_ADODB_LAYER')) {
	 ...
	 */
	$ADODB_vers = 'V1.65 28 Dec 2001 (c) 2000, 2001 John Lim (jlim@natsoft.com.my). All rights reserved. Released BSD & LGPL.';
	...
	*/
	...
	function GenID($seqname='adodbseq')
	{
		...
		if (!$rs) {
			...
			$createseq = $this->Execute(sprintf($this->_genSeqSQL,$seqname));
			$rs = $this->Execute($getnext);
		}
